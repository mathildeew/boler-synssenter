...
export default function RenderNews(data) {
  ...
  return (
    <div className="block mx-auto px-0 w-full">
      <div className="max-w-[1460px] w-full grid grid-cols-news gap-6 overflow-x-hidden snap-[x mandatory] gridExpand:grid-cols-2 lg:grid-cols-4">
        {articles.map((article) => {
          return (
            ...
            >
              <div className="text-darkPurple w-full h-full grid gap-3 snap-center items-center">
